...
def test_reports_generated():
    ...
    if os.path.exists("model.h5"):
        assert os.path.exists("reports/training_history.png"), (
            "Missing accuracy/loss plot"
        )
        assert os.path.exists("reports/confusion_matrix.png"), (
            "Missing confusion matrix plot"
        )
